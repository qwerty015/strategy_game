...
type Catalog struct {
	...
	BarracksHireSentryButton       string
	BarracksHireArcherButton       string
	BarracksHireSwordsmanButton    string
	FormationLinesLabel            string
	AdvisorTipEnemySighted         string
	SoldierGroupSplitButton        string
	SoldierGroupByProfessionButton string
	NoCargo                        string
	NoRoute                        string
	StateIdle                      string
	StateWorking                   string
	...
	UnitSentry                     string
	UnitEnemy                      string
	UnitWeaponsmith                string
	UnitArcher                     string
	UnitSwordsman                  string
	HireSerf                       string
