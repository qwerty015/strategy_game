...
func init() {
	register(EN, Catalog{
		...
		AdvisorTipConstructionMaterialsMissing: "Missing: %s × %d (site %d,%d)",
		AdvisorTipIdleBuilding:                 "Idle buildings: %d (e.g. at %d,%d)",
		AdvisorTipDisconnectedBuilding:         "Not connected by road: %d (e.g. at %d,%d)",
